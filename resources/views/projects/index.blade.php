                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">12
                                </td>
                                <td class="px-4 py-3">18
                                </td>
                                <td class="px-4 py-3">24
                                </td>
                                <td class="px-4 py-3">6
                                </td>
                                <td class="px-4 py-3">72
                                </td>
                                <td class="px-4 py-3">60
                                </td>
                                <td class="px-4 py-3">36
                                </td>
                                <!-- Action button with dropdown -->
                                <td class="flex items-center justify-end px-4 py-3">
                                    {{-- <button id="dropdown-button-{{ $orders->id }}" data-dropdown-toggle="dropdown-{{ $orders->id }}"
                                    ...
                                    {{-- <div id="dropdown-{{ $orders->id }}"
                                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm" aria-labelledby="dropdown-button-{{ $orders->id }}">
                                            <li>
