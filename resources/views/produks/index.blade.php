                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Work Order</th>
                                <th scope="col" class="px-4 py-3">Start Outsole</th>
                                <th scope="col" class="px-4 py-3">Finist Outsole</th>
                                <th scope="col" class="px-4 py-3">PO</th>
                                <th scope="col" class="px-4 py-3">Model Name</th>
                                <th scope="col" class="px-4 py-3">Style</th>
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">11/08/2024</td>
                                    <td class="px-4 py-3">1</td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">12/08/2024</td>
                                    <td class="px-4 py-3">12/08/2024</td>
                                    <td class="px-4 py-3">82024001
                                    </td>
                                    <td class="px-4 py-3">NIKE AIR MAX PLUS
                                    </td>
                                    <td class="px-4 py-3">4510-772
                                    </td>
                                    <td class="px-4 py-3">228
                                    </td>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">12/08/2024</td>
                                <td class="px-4 py-3">12/08/2024</td>
                                <td class="px-4 py-3">82024008
                                </td>
                                <td class="px-4 py-3">NIKE DUNK LOW
                                </td>
                                <td class="px-4 py-3">2340-018
                                </td>
                                <td class="px-4 py-3">510
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">12/08/2024</td>
                                <td class="px-4 py-3">13/08/2024</td>
                                <td class="px-4 py-3">82024010
                                </td>
                                <td class="px-4 py-3">NIKE DUNK LOW
                                </td>
                                <td class="px-4 py-3">2360-018
                                </td>
                                <td class="px-4 py-3">402
                                </td>
                                <td class="flex items-center justify-end px-4 py-3">
                                    <button id="apple-imac-27-dropdown-button"
                                        data-dropdown-toggle="apple-imac-27-dropdown"
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">13/08/2024</td>
                                <td class="px-4 py-3">13/08/2024</td>
                                <td class="px-4 py-3">82024013

                                </td>
                                <td class="px-4 py-3"> NIKE AIR MAX JORDAN

                                </td>
                                <td class="px-4 py-3">7244-001

                                </td>
                                <td class="px-4 py-3">792
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">13/08/2024</td>
                                <td class="px-4 py-3">14/08/2024</td>
                                <td class="px-4 py-3">82024017

                                </td>
                                <td class="px-4 py-3">NIKE DUNK LOW

                                </td>
                                <td class="px-4 py-3">2340-001

                                </td>
                                <td class="px-4 py-3">426
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">14/08/2024</td>
                                <td class="px-4 py-3">16/08/2024</td>
                                <td class="px-4 py-3">82024019
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">16/08/2024</td>
                                <td class="px-4 py-3">16/08/2024</td>
                                <td class="px-4 py-3">82024045

                                </td>
                                <td class="px-4 py-3">NIKE AIR MAX PLUS

                                </td>
                                <td class="px-4 py-3">4510-712

                                </td>
                                <td class="px-4 py-3">522
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">16/08/2024</td>
                                <td class="px-4 py-3">19/08/2024</td>
                                <td class="px-4 py-3">82024050
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 max-w-[12rem] truncate">19/08/2024</td>
                                <td class="px-4 py-3">19/08/2024</td>
                                <td class="px-4 py-3">82024070
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form action="#">
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Size Run</label>
                            <input type="number" name="price" id="price"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Enter size range" required min="36" max="42">
                        </div>
                    </div>
                    <button type="submit"
                ...
                <form action="#">
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Enter size range" required="">
                        </div>
                    </div>
