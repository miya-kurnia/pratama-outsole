...
@php
    ...
    switch ($variant) {
        ...
        break;
        case 'secondary':
        $variantClasses = 'bg-white text-orange-500 hover:bg-orange-100 focus:ring-orange-500 dark:text-orange-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-orange-200';
        break;
        case 'success':
